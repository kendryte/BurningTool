...
#define array_create(element_type, n) _array_create(sizeof(element_type), n)
#define array_make(variable, element_type, n) _array_make(&variable, sizeof(element_type), n)
